#ifndef DISPATCHER_STRATEGIES_BALANCED_STRATEGY_H_
#define DISPATCHER_STRATEGIES_BALANCED_STRATEGY_H_
 ...
 */
class BalancedDispatcherStrategy : public IDispatcherStrategy {
...
private:
	...
	std::shared_ptr<ProcessorLoad> getWeightedRandomProcessor();
