...
Kp=readDefaultParameterValue<double>(fvar );
fvar= va_arg(parameters,char*);
Ki=readDefaultParameterValue<double>(fvar );
fvar= va_arg(parameters,char*);
Kd=readDefaultParameterValue<double>(fvar );

Method=va_arg(parameters,char*);
fvar= va_arg(parameters,char*);
dQ= readDefaultParameterValue<double>(fvar );
fvar = va_arg(parameters,char*);
X=readDefaultParameterValue<double>(fvar);
pidiv3=1.047197551;
u=0;
mu=0;
pu=0;
