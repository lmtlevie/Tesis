...
K[0]=readDefaultParameterValue<double>(fvar );
fvar= va_arg(parameters,char*);
K[1]=readDefaultParameterValue<double>(fvar );
fvar= va_arg(parameters,char*);
K[2]=readDefaultParameterValue<double>(fvar );
fvar= va_arg(parameters,char*);
K[3]=readDefaultParameterValue<double>(fvar );
fvar= va_arg(parameters,char*);
K[4]=readDefaultParameterValue<double>(fvar );
fvar= va_arg(parameters,char*);
K[5]=readDefaultParameterValue<double>(fvar );
fvar= va_arg(parameters,char*);
K[6]=readDefaultParameterValue<double>(fvar );
fvar= va_arg(parameters,char*);
K[7]=readDefaultParameterValue<double>(fvar );
fvar= va_arg(parameters,char*);
