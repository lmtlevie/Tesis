#include "qssWithXOutput.h"
void qssWithXOutput::init(double t,...) {
...
double qssWithXOutput::ta(double t) {
//This function return a double.
return sigma;
}
void qssWithXOutput::dint(double t) {
...
void qssWithXOutput::dext(Event x, double t) {
