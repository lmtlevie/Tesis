...
ud[0]= readDefaultParameterValue<double>(fvar );
fvar= va_arg(parameters,char*);
ud[1]= readDefaultParameterValue<double>(fvar );
fvar= va_arg(parameters,char*);
yd[0]= readDefaultParameterValue<double>(fvar );
fvar= va_arg(parameters,char*);
yd[1]= readDefaultParameterValue<double>(fvar );
