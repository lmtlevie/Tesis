...
class dqssv2o3: public BaseSimulator {
// Declare the state, output
// variables and parameters

#define MaxQ 10000000

public: // DEBUG make all variables public to enalbe debugger
// States
...
char nxt;		// nxt=: (Tau will expire first)
	 			// nxt=: (Y will expire first)
	   			// nxt=(No expiration expected)
...
public:
	dqssv2o3(const char *n): BaseSimulator(n) {};
	void init(double, ...);
//	double ta(double t);
	void dint(double);
