...
// check and throw error if directory 'plots' does not exist (or create it)
//if(!std::filesystem::is_directory("plots")){
//	if(!fs::create_directory("plots")){
//		throw std::runtime_error("gnuplot::init - Can not create 'plot' directory");
//	}
//}
//int random_int = this->dist(this->rng);
//sprintf(FName,"plots/%ld.csv",random_int);
//sprintf(Script,"plots/%ld.plt", random_int);
