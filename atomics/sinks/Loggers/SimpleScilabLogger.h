#if !defined SimpleScilabLogger_h
#define SimpleScilabLogger_h
...
/**
 * Same as the ScilabLogger, but it logs eveything: if the signal arrives multiple times at the same t, all of the values will be logged
 */
class SimpleScilabLogger : public IPowerDEVSLogger {
...
public:
	...
	SimpleScilabLogger(Simulator* model, bool useMultipleSimulationRuns);
	SimpleScilabLogger(Simulator* model, const std::string& baseLogingName, bool useMultipleSimulationRuns);
