...
void TelnetOpenTsdbClient::enqueueWrite(const std::string& addPointCommand)
{
...
void TelnetOpenTsdbClient::handle_write(const std::string& writtenPoint, const boost::system::error_code & error)
{
...
void TelnetOpenTsdbClient::handle_write_error(const std::string& error){
	this->writeErrors++;
...
//	this->m_socket->async_read_some(boost::asio::buffer(response), boost::lambda::var(ec) = boost::lambda::_1); FAILING COMPILE
