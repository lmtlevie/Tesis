...
public:
	CmdLineParameterSweeper(const std::string& simuRunVariableName, const std::string& parameterValuesVariableName, const std::string& parameterNamesVariableName) : IParameterSweeper(simuRunVariableName, parameterValuesVariableName, parameterNamesVariableName) {
