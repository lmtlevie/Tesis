...
public:
	...
	// returns the value according the the specified distribution;
    virtual void readParameters(const std::string& paramName)=0;
	...
	// returns the configuration name (the one used to load the distribution)
	virtual std::string getConfigurationName()=0;
};
