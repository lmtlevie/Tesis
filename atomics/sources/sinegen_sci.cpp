...
a=readDefaultParameterValue<double>(fvar );
fvar=va_arg( parameters, char*);
f=readDefaultParameterValue<double>(fvar );
fvar=va_arg( parameters, char*);
phi=readDefaultParameterValue<double>(fvar );
fvar=va_arg( parameters, char*);
k=readDefaultParameterValue<double>(fvar );
