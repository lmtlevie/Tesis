...
vbase=readDefaultParameterValue<double>(fvar );
fvar=va_arg( parameters, char*);
ampl=readDefaultParameterValue<double>(fvar );
fvar=va_arg( parameters, char*);
itim=readDefaultParameterValue<double>(fvar );
fvar=va_arg( parameters, char*);
etim=readDefaultParameterValue<double>(fvar );
