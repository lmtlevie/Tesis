...
Vu=readDefaultParameterValue<double>(fvar );
fvar=va_arg( parameters, char*);
Vl=readDefaultParameterValue<double>(fvar );
fvar=va_arg( parameters, char*);
Tu=readDefaultParameterValue<double>(fvar );
fvar=va_arg( parameters, char*);
Tl=readDefaultParameterValue<double>(fvar );
fvar=va_arg( parameters, char*);
Tr=readDefaultParameterValue<double>(fvar );
fvar=va_arg( parameters, char*);
Tf=readDefaultParameterValue<double>(fvar );
Method=va_arg(parameters,char*);
fvar=va_arg( parameters, char*);
dq=readDefaultParameterValue<double>(fvar );
