...
1. Open the model. Go to File -> Open, the choose folder `discrete/` and the file `nicholson_bailey.pdm`.
...
1. Open the model. Go to File -> Open, the choose folder `discrete/` and the file `qoperator.pdm`.
2. Press the play button or the F5 key.
3. A window pops up, then press "Run Simulation".
...
1. Open the model. Go to File -> Open, the choose folder `discrete/` and the file `statespace.pdm`.
2. Press the play button or the F5 key.
3. A window pops up, then press "Run Simulation".
