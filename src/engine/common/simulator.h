...
public:
	...
	/* Full name of this atomic. As an instance variable for performance, to avoid iterating structure each time */
	std::string fullName = "";
	...
	*   This function is virtual so an specific atomic overrides it with it's own implementation */
	...
	void init_from_vector(Time, const std::vector<std::string> &);
	...
	*   This function is virtual so an specific atomic overrides it with it's own implementation */
	...
	void externalinput(Time, int);
        //---------------------- agregado 24-01-2018 -----------------------
	void externalinput(Time , void*);//updated by Guillermina Galache
	void externalinput(Time , void*,char*);//updated by Guillermina Galache
        //-------------------------- fin agregado --------------------------
