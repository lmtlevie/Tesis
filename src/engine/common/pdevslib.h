...
void cleanNet(void); // EP: lo agregue para poder llamarla desde los atomicos
//-------------------------- fin agregado --------------------------

/*********************************************************************************************************
 ***********   std::make_unique is not availbe until c++14 *****************
 ***********   Here the implementation taken from the c++14 standard: http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2013/n3656.htm
 *********************************************************************************************************/
#include <cstddef>
#include <memory>
#include <type_traits>
...
/*********************************************************************************************************
 *********** end of  std::make_unique definition *****************
 *********************************************************************************************************/
