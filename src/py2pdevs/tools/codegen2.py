...
def parse_options():
    ...
    parser.add_argument('-r', '--atomics-dir-remote', dest='atomics_dir_remote', action='store',
                        type=str, required=True,
                        help='root directory of remote atomic models')
...
def codegen():
    ...
    model_classes_rem = find_model_classes(args.atomics_dir_remote)
    model_classes.extend(model_classes_rem)
